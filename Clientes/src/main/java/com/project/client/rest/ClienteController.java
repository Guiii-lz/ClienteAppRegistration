...
import com.project.client.model.repository.ClienteRepository;
...
public class ClienteController {
	...
	@GetMapping("{id}")
	public Cliente searchId( @PathVariable Integer id) {
		return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND,"Cliente não encontrado"));
	}
	
	@DeleteMapping("{id}")
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public void deletarId( @PathVariable Integer id) { //podendo ser um simples repository.deletebyid
